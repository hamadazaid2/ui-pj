...
<body class="antialiased">
    <div
        ...
        @endif
        <div style="width: 30rem; text-align: center;">
            <div>
                <h1 style="font-size: 2rem" class="text-sm text-gray-700 dark:text-gray-500 underline">Edit Store Form
                </h1>
            </div>
            <div style="text-align: left">
                ...
                <form method="POST" action="{{ route('offer.update', $offer->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input style="font-size: 1.2rem" type="text" class="form-control"
                            placeholder="Enter Offer Price" class="forminput" name="price"
                            value="{{ $offer->price }}">
                        <br>
                        @error('price')
                            <small style="color: red" class="form-text text-danger">{{ $message }}</small>
                    ...
                    <div class="form-group">
                        ...
                        <input id="photo" style="font-size: 1.2rem" type="file" class="form-control"
                            class="forminput" name="photo">
                        <br>
                        @error('phote')
                            <small style="color: red" class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <button type="submit" class="formbtn">Edit Offer</button>
                </form>
            </div>
        </div>
