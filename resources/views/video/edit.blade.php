        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 col-xl-6 text-center">
                    <h2 class="mt-0">Edit video from youtube</h2>
                    <hr class="divider" />
                    ...
                    <form method="POST" action="{{ route('video.update', $video->id) }}">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="name" type="text" placeholder="Enter your name..."
                                data-sb-validations="required" name="name" value="{{$video->name}}"/>
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="link" type="text" placeholder="name@example.com"
                                data-sb-validations="required,email" name="embed_link" value="{{$video->embed_link}}"/>
                        ...
                        <!-- Submit Button-->
                        <div class="d-grid">
                            <button class="btn btn-primary btn-xl enable" id="submitButton" type="submit">Edit</button>
                        </div>
                    </form>
                </div>
            </div>
